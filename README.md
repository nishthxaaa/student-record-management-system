# student-record-management-system# Student Record Management System
A minimalist console based application to managae students record. **record are saved directly on an excel file to decrease data Entry labour cost**  and improves efficiency.
